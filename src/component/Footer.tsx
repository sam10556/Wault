import { Fingerprint, Mail, Phone, MapPin, Instagram, Twitter, Linkedin } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              The future of secure deliveries. Smart, simple, and absolutely essential for modern living.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-gray-400">
                ...
                <span className="text-sm">hello@wault.com</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-400">
                <Phone className="w-4 h-4" />
                <span className="text-sm">1-800-WAULT-01</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-400">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © 2025 Wault. All rights reserved. Made with ❤️ for the future of secure deliveries.
          </p>
        </div>
      </div>
    </footer>
